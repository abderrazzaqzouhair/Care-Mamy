...
import com.app.caremama.auth.AuthManager
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val selectLang:TextView = view.findViewById(R.id.selectLang)
        ...
        val cardProfileInfo: CardView = view.findViewById(R.id.cardProfileInfo)
        val my_info: TextView = view.findViewById(R.id.my_info)
